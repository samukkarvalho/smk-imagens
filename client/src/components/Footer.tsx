        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
          ...
          <div>
            ...
            <div className="flex gap-4" role="group" aria-label="Redes sociais">
              <a href="https://www.instagram.com/smkimagens/" target="_blank" rel="noopener noreferrer nofollow" aria-label="Visite nosso Instagram (abre em nova aba)" className="flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-purple-600 via-pink-600 to-orange-500 text-white font-semibold rounded-lg hover:scale-105 transition-transform duration-300">
